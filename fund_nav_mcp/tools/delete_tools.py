...
async def delete_fund(data: FundDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金产品"""
...
async def delete_funds(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金产品"""
...
async def delete_fund_manager(data: FundManagerDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金管理人（机构）"""
...
async def delete_fund_managers(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金管理人（机构）"""
...
async def delete_fund_manager_person(data: FundManagerPersonDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金管理人（个人）"""
...
async def delete_fund_manager_persons(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金管理人（个人）"""
...
async def delete_fund_category(data: FundCategoryDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金分类"""
...
async def delete_fund_categories(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金分类"""
...
async def delete_fund_category_mappings(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金分类映射"""
...
async def delete_fund_nav(data: FundNavDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金净值"""
...
async def delete_fund_navs(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金净值"""
...
async def delete_fund_return(data: FundReturnDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金收益率"""
...
async def delete_fund_returns(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金收益率"""
...
async def delete_fund_holding(data: FundHoldingDelete, db_name: str = "default") -> UtilResponse:
    """删除单条基金持仓"""
...
async def delete_fund_holdings(ids: List[int], db_name: str = "default") -> UtilResponse:
    """批量删除基金持仓"""
